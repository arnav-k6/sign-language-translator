...
DATA_FILE = os.path.join(_SCRIPTS_DIR, '..', 'data', 'landmark_data.csv')
MODEL_FILE = os.path.join(_SCRIPTS_DIR, '..', 'models', 'gesture_model_pytorch.pth')
SCALER_FILE = os.path.join(_SCRIPTS_DIR, '..', 'models', 'gesture_scaler.pkl')
LABEL_ENCODER_FILE = os.path.join(_SCRIPTS_DIR, '..', 'models', 'label_encoder.pkl')
