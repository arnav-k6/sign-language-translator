...
model_path = os.path.join(_TESTS_DIR, '..', 'models', 'hand_landmarker.task')
MODEL_FILE = os.path.join(_TESTS_DIR, '..', 'models', 'gesture_model_pytorch.pth')
SCALER_FILE = os.path.join(_TESTS_DIR, '..', 'models', 'gesture_scaler.pkl')
