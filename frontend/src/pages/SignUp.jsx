        ...
        >
            <div style={{
                ...
                <div style={{ marginBottom: '3.5rem' }}>
                    ...
                    <h1 style={{ fontSize: '2.5rem', fontWeight: '200', letterSpacing: '-0.06em' }}>Sign Up.</h1>
                    <p style={{ color: '#888', marginTop: '0.75rem', fontSize: '1.1rem', fontWeight: '300', letterSpacing: '-0.02em' }}>Create your account to start</p>
                </div>
                ...
                <form onSubmit={handleSignUp} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', textAlign: 'left' }}>
                    ...
                    <button type="submit" className="btn btn-primary" style={{
                        ...
                        Create Account. <ArrowRight size={18} strokeWidth={1} />
                    </button>
                </form>

                <div style={{ marginTop: '3rem', fontSize: '0.9375rem', color: '#a1a1a1' }}>
                    Already have an account? <Link to="/login" style={{ color: '#000', fontWeight: '400', textDecoration: 'none', marginLeft: '4px', borderBottom: '0.5px solid #000' }}>Log in</Link>
                </div>
            </div>
        </motion.div>
    );
